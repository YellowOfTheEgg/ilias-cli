...
var (
	exerciseListCmdNode, _ = getCmdNodeFromFile("exercise_list")
	listPath string = "ilias.php?exc_mem_trows=0&cmd=members&cmdClass=ilexercisemanagementgui&cmdNode="+exerciseListCmdNode+"&baseClass=ilExerciseHandlerGUI"
)
