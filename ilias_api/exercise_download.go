...
var (
	downloadPathCmdNode, _ = getCmdNodeFromFile("exercise_download")
	downloadPath string = "ilias.php?vw=1&cmd=downloadReturned&cmdClass=ilexsubmissionfilegui&cmdNode="+downloadPathCmdNode+"&baseClass=ilExerciseHandlerGUI"
)
