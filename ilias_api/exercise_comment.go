...
var (
	exerciseCommentCmdNode, _ = getCmdNodeFromFile("exercise_comment")
	commentPath = "ilias.php?vw=1&cmd=saveCommentForLearners&cmdClass=ilexercisemanagementgui&cmdNode="+exerciseCommentCmdNode+"&baseClass=ilExerciseHandlerGUI&cmdMode=asynch"
)
