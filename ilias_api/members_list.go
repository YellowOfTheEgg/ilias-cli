...
var (
	membersListCmdNode, _ = getCmdNodeFromFile("members_list")
	memberListPath string = "ilias.php?cmdClass=ilcoursemembershipgui&cmdNode="+membersListCmdNode+"&baseClass=ilrepositorygui"
)
