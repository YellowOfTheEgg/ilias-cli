...
var (
	authLoginCmdNode, _ = getCmdNodeFromFile("auth_login")
	loginPath = "ilias.php?lang=de&client_id=UniRZ&cmd=post&cmdClass=ilstartupgui&cmdNode="+authLoginCmdNode+"&baseClass=ilStartUpGUI&rtoken="
)
