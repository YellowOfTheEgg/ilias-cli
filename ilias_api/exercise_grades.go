...
var (
	exerciseGradesCmdNode, _ = getCmdNodeFromFile("exercise_grades")
	gradesPath = "ilias.php?vw=1&cmd=post&cmdClass=ilexercisemanagementgui&cmdNode="+exerciseGradesCmdNode+"&baseClass=ilExerciseHandlerGUI&fallbackCmd=saveStatusAll"
	gradesOverviewPath = "ilias.php?cmd=showGradesOverview&cmdClass=ilexercisemanagementgui&cmdNode="+exerciseGradesCmdNode+"&baseClass=ilExerciseHandlerGUI"
)
